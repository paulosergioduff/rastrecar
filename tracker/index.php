...
$nome_empresa = strtoupper($login_padrao);

if($login_padrao != 'rastreiamaisbrasil'){
$cons_empresa = mysqli_query($conn,"SELECT * FROM clientes WHERE subdominio='$nome_empresa'");
...
<script src="https://kit.fontawesome.com/a132241e15.js"></script>
    ...
    <link href="http://jctracker.com.br/tracker/font-awesome/css/font-awesome.css" rel="stylesheet">
	 <link rel="icon" type="image/png" sizes="32x32" href="/tracker/Imagens/logo1.png">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            <div>
                ...
                <img src="/tracker3/manager/logos/<?php echo $logo?>" style="width:80%; height:auto">
		...
		<script>
            ...
            <p class="m-t"> <small>RBM Rastreamento Veicular</small> </p>
        </div>
    </div>
