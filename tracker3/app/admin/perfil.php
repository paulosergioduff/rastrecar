            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
					...
					<?php
					 ...
					 $cons_cliente = mysqli_query($conn,"SELECT * FROM clientes WHERE id_cliente='1404'");
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-user-circle'></i> Meu Perfil
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											<div class="row">
												<div class="col-6">
													<h3>Telefone:</h3><br>
													<span style="color:#999"><?php echo $telefone_celular?></span>
												</div>
											...
											<div class="row">
												<div class="col-8">
													<h3>Celulares Conectados:</h3><br>
												</div>
												<div class="col-4 text-right">
													<a href="celulares.php?id=<?php echo $id_push?>"><span style="color:#000"><i class="fas fa-chevron-right fa-2x"></i></span></a>
												</div>
											</div>
											<!--
											<hr style="border:#CCC 1px dashed;">
											...
											<div class="row">
												<div class="col-8">
													<h3>Notificações Whatsapp:</h3><br>
												</div>
												<div class="col-4 text-right">
													<a href="notif_whats.php?id=<?php echo $id_push?>&id_usuarios=<?php echo $id_usuarios?>"><span style="color:#000"><i class="fas fa-chevron-right fa-2x"></i></span></a>
												</div>
											</div>
											-->
                                        </div>
                        ...
                        <div class="row">
							<div class="col-12">
							<a href="alterar_senha.php?id=<?php echo $id_push?>"><button type="button" data-toggle="modal" data-target="#carregar" class="btn btn-info" style="width:100%">Alterar Senha</button></a>
							</div>	
						</div>
