                ...
                <div class="page-content-wrapper header-function-fixed">
					...
					<?php
					  $cons_user1 = mysqli_query($conn,"SELECT * FROM usuarios_push WHERE id_push='$id_push' ");
						...
						$user10 = explode("@", $usuario);
						$user30 = $user10[0];
							}}
						
						$cons_cliente_v = mysqli_query($conn,"SELECT * FROM clientes WHERE id_cliente = '$id_cliente'");
							if(mysqli_num_rows($cons_cliente_v) > 0){
						while ($resp_cliente_c = mysqli_fetch_assoc($cons_cliente_v)) {
						$doc_cliente = 	$resp_cliente_c['doc_cliente'];		
						$documento = preg_replace("/[^0-9]/", "", $doc_cliente);
							}}
					
						if($user30 == $documento){
							$id_cliente20 = $id_cliente;
						}
						if($user30 != $documento){
							$id_cliente20 = '9999999';
						}
					?>
						...
						<div class="row">
                            <div class="col-12">
								<div class="form-group">
									...
									$result_usuario = mysqli_query($conn, "SELECT * FROM contas_receber WHERE id_cliente='$id_cliente20' ORDER BY data_vencimento DESC LIMIT 10");
										if(mysqli_num_rows($result_usuario) > 0){
											...
											if($status == 'Em Aberto' && $data_vencimento < $data_hoje){
												...
												$status1 = '<h3><span class="badge" style="background-color:#CD5C5C;color:#FFF"><b> EM ATRASO</b></span></h3>';
											...
											if($status == 'Em Aberto' && $data_vencimento >= $data_hoje){
												...
												$status1 = '<h3><span class="badge" style="background-color:#4169E1;color:#FFF"><b> EM ABERTO</b></span></h3>';
											...
											if($status == 'Pago'){
												...
												$status1 = '<h3><span class="badge" style="background-color:#009900;color:#FFF"><b> PAGO</b></span></h3>';
												
											}
											
											if($especie == 2){
												$forma_pgto = '<i class="fal fa-barcode-alt"></i> Boleto Bancário';
											}
											if($especie == 13){
												$forma_pgto = '<i class="fal fa-credit-card"></i> Cartão de Crédito';
									...
									<div id="panel-1" class="panel">
										<div class="panel-container show">
											<div class="panel-content">
												...
												<div class="row">
													<div class="col-5">
														Valor: <b>R$<?php echo $valor_bruto1; ?></b>
													</div>
													<div class="col-7">
														Tipo: <b><?php echo $forma_pgto; ?></b>
													</div>
												</div><br>
												<div class="row">
													<div class="col-12">
														Referente: <b><?php echo $categoria; ?></b>
													</div>
												</div><br>
												<div class="row">
													<div class="col-12">
