...
if($veiculos == '0'){
	$tabela1 = "SELECT * FROM tc_devices WHERE contact='$id_cliente_login' AND positionid >= '1' ORDER BY positionid DESC";
}
if($veiculos != '0'){
	$tabela1 = "SELECT * FROM tc_devices WHERE id IN ($veiculos) ORDER BY lastupdate ASC";
}
			...
			$result_usuario = mysqli_query($conn, $tabela1);
				...
				?>
							...
							<div class="card" style="border:<?php echo $cor_ign?> 1px solid;border-left:<?php echo $cor_ign?> 8px solid;">
								...
								<div id="veic<?php echo $deviceid?>" class="collapse <?php echo $abrir?>" aria-labelledby="headingTwo" data-parent="#accordionExample">
									<div class="card-body">
										<div class="row">
										...
										<div class="row">
											<div class="col-12 d-flex flex-row align-items-center">
												<div class="p-1 mr-1">
												   <i class="fas fa-road fa-2x" style="color:#000"></i>
												</div>
												<div>
													<label class="fs-sm mb-0">KM do dia: <?php echo $totalkm?> km rodados</label>
												</div>
											</div>
