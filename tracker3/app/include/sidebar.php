...
var migrado = document.getElementById("migrado").value;
var tipo = document.getElementById("tipo").value;
var id_push = document.getElementById("id_push").value;

	if(tipo == 'ADMIN'){
		location.href = "/tracker3/app2/admin/index.php?id="+id_push+"&app=on"
	}
	if(tipo == 'TECNICO'){
		location.href = "/tracker3/app2/tecnico/index.php?id="+id_push+"&app=on"
	}
	if(tipo == 'CLIENTE'){
		location.href = "/tracker3/app2/index.php?id="+id_push+"&app=on"
	}
</script>
