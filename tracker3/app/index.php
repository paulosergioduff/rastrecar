					...
					$total_veiculos = mysqli_num_rows($cons_cliente11);
					 ...
					 $cons_cliente = mysqli_query($conn,"SELECT * FROM clientes WHERE id_cliente='$id_cliente' ");
						if(mysqli_num_rows($cons_cliente) > 0){
							while ($resp_cli = mysqli_fetch_assoc($cons_cliente)) {
							$status_cliente = 	$resp_cli['status'];

						}}
						
					if($status_cliente == 2){
						header('Location: bloqueio.php?id_cliente='.$id_cliente.'');
					}
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-car'></i> Meus Veículos
                        ...
                        <div id="grid_veiculos" style="width:100%">
							<div class="row">
								<div class="col-12 text-center">
									<span style="fonta-size:20px"><img src="/tracker2/Imagens/load.gif" width="55px" height="55px"><br>Carregando Veículo(s)</span>
								</div>
							</div>
...
<script>
	...
	$(document).ready(function () {
		...
		$.post('include/grid_veiculos.php?id='+id_cliente_b+'&id_push='+id_push+'&id_usuarios='+id_usuarios, function(veiculos){
