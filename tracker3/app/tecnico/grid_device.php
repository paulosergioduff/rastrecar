					 ...
					 <div class="card" style="border:#999 1px solid;">
						...
						<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-6 text-center">
										<button type="button" class="btn btn-success shadow-0" style="width:100%"><i class="fas fa-clipboard-check"></i> Finalizar OS</button>
									</div>
									<div class="col-6 text-center">
										<a href="index.php?id=<?php echo $id_cliente_login?>"><button type="button" class="btn btn-dark shadow-0" style="width:100%" data-toggle="modal" data-target="#carregar"><i class="fas fa-step-backward"></i> Voltar</button></a>
									</div>
								</div><br>
...
var ancora_on = document.getElementById("ancora_on").value;
	...
	mapboxgl.accessToken = 'pk.eyJ1IjoiZWR1YXJkb3JpcG9sbCIsImEiOiJja2Vlamdxd3cwa2xyMnRsZ25uYnJ2NDRvIn0.ctvYJBvMap_X1IpCackV-A';
            ...
            if(mapboxMarkers[i].name == name){
                  ...
                  if(String(ign) != String(mapboxMarkers[i].ign)
                          || String(point) != String(mapboxMarkers[i].point)
							...
							'url(/tracker2/Imagens/icons/'+ign;
							el.style.width = '35px';
...
<script>
 ...
 <script>
	var intervalo2 = setInterval(function() { $('#top_veiculo').load('include/grid_device1.php?id_device='+deviceid); }, 1000);
</script>
 <script>
	var intervalo3 = setInterval(function() { $('#informacoes').load('include/grid_device2.php?id_device='+deviceid); }, 1000);
</script>
        <script>
