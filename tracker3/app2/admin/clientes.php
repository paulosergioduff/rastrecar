...
<div id="page">
    ...
    <div id="footer-bar" class="footer-bar-5">
        <a href="mapa.php?id=<?php echo $id_push?>" onclick="carregar();"><i class="fas fa-car"></i><span>Veículos</span></a>
    ...
    <div class="page-content">
        ...
        <!-- Homepage Slider-->
		 ...
		 <div class="card card-style shadow-xl">        
            <div class="content">
                ...
                <p class="mb-1">
                    Foram encontrados <?php echo $total_veiculos?> Clientes.
                </p>
            </div>
        </div>
        ...
        <?php
		$cons_cli = mysqli_query($conn,"SELECT * FROM clientes WHERE status='1' OR status='2' ORDER BY nome_cliente ASC");
