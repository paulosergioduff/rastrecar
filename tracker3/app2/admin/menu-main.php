...
<div class="menu-items">
    ...
    <a id="nav-starters" href="mapa.php?id=<?php echo $id_push1?>" class="trocar" onclick="carregar2()">
        <i class="fas fa-map-marked-alt gradient-dark color-dark fa-2x"></i>
        <span>Mapa Geral</span>
        <i class="fa fa-circle"></i>
    </a>
	<a id="nav-clientes" href="clientes.php?id=<?php echo $id_push1?>" class="trocar" onclick="carregar2()">
        <i class="fas fa-user gradient-dark color-dark fa-2x"></i>
        <span>Clientes</span>
        <i class="fa fa-circle"></i>
    </a>
