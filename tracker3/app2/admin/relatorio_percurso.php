    ...
    <div class="page-content">
        ...
        <!-- Homepage Slider-->
		 ...
		 <div class="card card-style shadow-xl">        
            <div class="content">
				...
				<p>Este relatório irá demonstrar o percurso realizado pelo veículo, com endereço, velocidade e status de Ignição. Selecione o período desejado. Para períodos maiores, por favor, acesse www.mobidrive.mobitracker.com.br</p>
            </div>
       ...
       <div class="card card-style shadow-xl">        
            <div class="content">
                <div class="row">
					<div class="col-2">
							<img width="50" class="fluid-img rounded-m shadow-xl" src="../app2/imagens/veiculos/<?php echo $modelo_img?>.png">
						</div>
					<div class="col-10">
