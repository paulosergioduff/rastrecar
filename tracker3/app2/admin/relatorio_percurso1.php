...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'http://207.244.228.189:8082/api/reports/summary?from='.$data_inicial22.'&to='.$data_final22.'&deviceId='.$deviceid.'',
        ...
        <!-- Homepage Slider-->
		 ...
		 <div class="card card-style shadow-xl">        
            <div class="content">
				...
				<p>Este relatório irá demonstrar o percurso realizado pelo veículo, com endereço, velocidade e status de Ignição. Selecione o período desejado. Para períodos maiores, por favor, acesse www.jctracker.com.br</p>
            </div>
