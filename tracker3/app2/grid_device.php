...
<div id="page">
    ...
    <div id="footer-bar" class="footer-bar-5">
        <a href="index.php?id=<?php echo $id_push?>" ><i class="fas fa-car"></i><span>Veículos</span></a>
	...
	<div id="bloqueio" class="menu menu-box-modal rounded-m" 
        ...
        <div class="row mr-3 ml-3 mb-0">
            ...
            <div class="col-6">
                <a href="comandos/comandos.php?deviceid=<?php echo $deviceid?>&id=<?php echo $id_push?>&nome_user=<?php echo $nome_user?>&t=BLOQUEIO&model=<?php echo $modelo_equip?>"  onclick="bloqueio();" class="btn btn-sm btn-full button-s shadow-l rounded-s text-uppercase font-900 bg-blue1-dark">Confirmar</a>
            </div>
        </div>
    </div> 
	...
	<div id="ancora-menu" class="menu menu-box-modal rounded-m" 
        ...
        <div class="row mr-3 ml-3 mb-0">
            ...
            <div class="col-6">
                <a href="<?php echo $link_ancora?>"  onclick="ancora1();" class="btn btn-sm btn-full button-s shadow-l rounded-s text-uppercase font-900 bg-blue1-dark">Confirmar</a>
            </div>
        </div>
    </div> 
	...
	<div id="desbloqueio" class="menu menu-box-modal rounded-m" 
        ...
        <div class="row mr-3 ml-3 mb-0">
            ...
            <div class="col-6">
                <a href="comandos/comandos.php?deviceid=<?php echo $deviceid?>&id=<?php echo $id_push?>&nome_user=<?php echo $nome_user?>&t=DESBLOQUEIO&model=<?php echo $modelo_equip?>"  onclick="bloqueio();" class="btn btn-sm btn-full button-s shadow-l rounded-s text-uppercase font-900 bg-blue1-dark">Confirmar</a>
            </div>
        </div>
    </div>
