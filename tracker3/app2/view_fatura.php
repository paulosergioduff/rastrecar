		   ...
		   <div class="card card-style shadow-xl">        
            <div class="content">
                <p class="mb-1">
                    ...
                    <h2 class="font-14 font-700 mb-2"><i class="fas fa-history fa-2x"></i> Aguardando Pagamento</h2>
...
<script>
	...
	var intervalo2 = setTimeout(function() { $('#qrcode').load('teste.php?id_conta='+id_conta); }, 1000);
</script>
<script>
	function carregar(){
		$('#aguarde').showMenu();
