		...
		if($especie == 13){
			if($card_number != ''){
				if($bandeira == 'MASTERCARD'){
					$bandeira1 = '<img src="images/pictures/mastercard.jpg">';
					$forma_pagamento = 'Cartão de Crédito';
					$final = '<span class="badge bg-dark font-11">Final '.$numero.'</span>';
				}
				elseif($bandeira == 'VISA'){
					$bandeira1 = '<img src="images/pictures/visa.jpg">';
					$forma_pagamento = 'Cartão de Crédito';
					$final = '<span class="badge bg-dark font-11">Final '.$numero.'</span>';
				}
				elseif($bandeira == 'ELO'){
					$bandeira1 = '<img src="images/pictures/elo.jpg">';
					$forma_pagamento = 'Cartão de Crédito';
					$final = '<span class="badge bg-dark font-11">Final '.$numero.'</span>';
				}
				elseif($bandeira == 'HIPERCARD'){
					$bandeira1 = '<img src="images/pictures/hipercard.jpg">';
					$forma_pagamento = 'Cartão de Crédito';
					$final = '<span class="badge bg-dark font-11">Final '.$numero.'</span>';
				}
				elseif($bandeira == 'AMEX'){
					$bandeira1 = '<img src="images/pictures/amex.jpg">';
					$forma_pagamento = 'Cartão de Crédito';
					$final = '<span class="badge bg-dark font-11">Final '.$numero.'</span>';
				}
				elseif($bandeira == 'DINNERS'){
					$bandeira1 = '<img src="images/pictures/dinners.jpg">';
					$forma_pagamento = 'Cartão de Crédito';
					$final = '<span class="badge bg-dark font-11">Final '.$numero.'</span>';
				}
				else {
		  ...
		  <div class="card card-style shadow-xl">        
            <div class="content">
                <p class="mb-1">
                    ...
                    <h2 class="font-14 font-700 mb-2"><i class="fas fa-check-circle fa-2x" style="color:#009900"></i> Fatura Paga em <?php echo $data_pagamento1?></h2>
