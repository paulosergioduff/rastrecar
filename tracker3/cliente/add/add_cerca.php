...
$sql = mysqli_query($conn, "INSERT INTO cerca_virtual (geofenceid, id_cliente, endereco, latitude, longitude, radius, nome_cerca, data_criacao, id_empresa, area, tipo) VALUES ('$id', '$id_cliente', '$endereco', '$latitude', '$longitude', '$radius_size', '$nome_cerca', '$data_criacao', '$id_empresa', '$coordenadas1', '$tipo_cerca')");
