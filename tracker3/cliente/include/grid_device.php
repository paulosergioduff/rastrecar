...
$data_agora1 = date('Y-m-d H:i:s', strtotime('-5 minutes', strtotime($data_agora)));
			...
			while($row_usuario = mysqli_fetch_assoc($resultado_usuario)){
				...
				if($status_conexao == 'off'){
					$alimentacao = '<h3><span class="badge badge-secondary" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Sem Informação"><i class="fas fa-plug"></i></span></h3>';
				}
				...
				?>
					...
					<div class="row">
						<div class="col-5 d-sm-flex align-items-center">
							<div class="p-1 mr-1">
					...
					<div class="row">
						<div class="col-12 d-sm-flex align-items-center">
							...
							<div>
								<label class="fs-sm mb-0"><?php echo $nome_cliente?></label>
							</div>
						</div>
					</div>
