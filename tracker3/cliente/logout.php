<?php
	...
	$cons_cliente10 = mysqli_query($conn,"SELECT * FROM clientes WHERE id_cliente='$id_cliente_pai'");
	if(mysqli_num_rows($cons_cliente10) > 0){
	while ($resp_cliente1 = mysqli_fetch_assoc($cons_cliente10)) {
		$subdominio = 	$resp_cliente1['subdominio'];
		}}
