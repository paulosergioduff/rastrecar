											...
											<div class="row">
												...
												<div class="col-md-6">
													...
													<div class="row">
														...
														<div class="col-md-4">
															<a href="delete_veic_cerca.php?deviceid=<?php echo $deviceid?>&geofenceid=<?php echo $geofenceid?>&pag=0"><button type="button" class="btn btn-danger btn-sm"><i class="fal fa-trash-alt"></i> Excluir</button></a>
														</div>
													</div>
