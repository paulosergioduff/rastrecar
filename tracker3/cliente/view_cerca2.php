                            ...
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
											...
											<div class="row">
												...
												<div class="col-md-6">
													...
													<div class="row">
														...
														<div class="col-md-4">
															<button type="button" class="btn btn-danger btn-sm"><i class="fal fa-trash-alt"></i> Excluir</button>
														</div>
													</div>
													...
													<select class="select2-placeholder-multiple form-control" multiple="multiple" name="veiculos[]" id="veiculos">
														...
														$cons_veic = mysqli_query($conn,"SELECT * FROM veiculos_clientes WHERE deviceid NOT IN ($deviceid) ORDER BY placa ASC");
										...
										<input type="text" id="tipo" value="<?php echo $tipo?>">	
                                        </div>
                                    </div>
                                </div>
                            </div>
