...
$cor_sistema1 = $resp_cliente['cor_sistema'];
	}}
	
if($cor_sistema1 != ''){
	$cor_sistema2 = $cor_sistema1;
}
if($cor_sistema1 == ''){
	$cor_sistema2 = '#14145A';
}
                                        ...
                                        <div class="col-6">
										 ...
										 <div class="col-12">
                                            <div class="p-3 text-center">
											   ...
											   <a href="cad_cliente_faturas.php?c=<?php echo $base64_cliente?>"><button type="button" class="btn btn-outline-dark btn-sm" style="width:90%" onclick="carrega()"><i class="fal fa-dollar-sign"></i> Faturas</button></a><br><br>
											  <a href="cad_cliente_os.php?c=<?php echo $base64_cliente?>"><button type="button" class="btn btn-outline-dark btn-sm" style="width:90%" onclick="carrega()"><i class="fal fa-file-edit"></i> Ordens de Serviço</button></a><br><br>
											   <a href="cad_cliente_crm.php?c=<?php echo $base64_cliente?>"><button type="button" class="btn btn-outline-dark btn-sm" style="width:90%" onclick="carrega()"><i class="fal fa-comments"></i> CRM/Atendimentos</button></a><br><br>
											   <a href="cad_cliente_acesso.php?c=<?php echo $base64_cliente?>"><button type="button" class="btn btn-outline-dark btn-sm" style="width:90%" onclick="carrega()"><i class="fal fa-sign-in-alt"></i> Acesso Web/App</button></a><br><br>
												<button type="button" class="btn btn-dark btn-sm" style="width:90%" ><i class="fal fa-cogs"></i> Conf. Sistema</button><br><br>
												<?php echo $botao_del?>
                                            </div>
                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											<div class="row">
												<div class="col-md-4">
													<label>Cor Sistema do cliente:</label>
                                                    <input class="form-control" id="cor_sistema" type="color" name="cor_sistema" value="<?php echo $cor_sistema2?>">
                                                    <input class="form-control" id="id_cliente_conf" type="hidden" name="id_cliente_conf" value="<?php echo $id_cliente?>">
												</div>
												<div class="col-md-8">
													<label>Logo:</label><br>
											...
											<div class="row">
												<div class="col-md-4">
													<label>Telefone Atendimento:</label>
                                                    <input class="form-control" id="telefone_atendimento" type="text" name="telefone_atendimento">
												</div>
											</div><br>
											<div class="row">
												<div class="col-md-4">
	...
	<script>
			$(document).on('submit', 'form', function (e) {
				...
				request.addEventListener('load', function(e){
    				...
    				clearInterval(i);
					location.href = 'cad_cliente.php?c=<?php echo $base64?>';
					}, 1500);
				});
				
				//Arquivo responsável em fazer o upload da imagem
				request.open('post', 'add_conf.php');
