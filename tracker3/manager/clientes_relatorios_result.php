                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											<h3>
											<a href="excel/clientes_relatorio.php?cliente=<?php echo $clientes?>&cliente_pai=<?php echo $cliente_pai?>&bloqueados=<?php echo $bloqueados?>"><button type="button" class="btn btn-success btn-sm shadow-0"><i class="fas fa-file-excel"></i> Excel</button></a> 
											<a href="pdf_files/clientes_relatorio.php?cliente=<?php echo $clientes?>&cliente_pai=<?php echo $cliente_pai?>&bloqueados=<?php echo $bloqueados?>" target="_blank"><button type="button" class="btn btn-sm shadow-0" style="background-color:#CD5C5C; color:#FFF"><i class="fas fa-file-pdf"></i> PDF</button></a>
											<a href="clientes_relatorios.php"><button type="button" class="btn btn-primary btn-sm shadow-0"><i class="fas fa-file"></i> Novo Relatório</button></a>
											</h3>
											...
											$resultado_usuario = mysqli_query($conn, "SELECT * FROM clientes WHERE id_cliente IN ($clientes) ORDER BY nome_cliente ASC");
