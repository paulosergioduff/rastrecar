...
$url = 'http://144.91.86.255:8082/api/commands/send';
...
if($response_code == 200){
	header('Location: ../editar_equipamento.php?c='.$base64.'&res=200');
} 

if($response_code == 202){
    header('Location: ../editar_equipamento.php?c='.$base64.'&res=202');
} 

if($response_code == 400){
	header('Location: ../editar_equipamento.php?c='.$base64.'&res=400');
}
if($response_code == 401){
	header('Location: ../editar_equipamento.php?c='.$base64.'&res=401');
}
