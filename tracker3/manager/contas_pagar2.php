                ...
                <div class="page-content-wrapper header-function-fixed">
					...
					$id_empresa = '1362';
						if($acesso == 'GERAL'){
							...
							$botao_loja2 = '<a href="contas_pagar.php"><button type="button" class="btn btn-dark btn-sm" style="font-size:14px"><i class="fal fa-home"></i> Loja Horizonte</button></a>';	
						}
						if($id_empresa == '1361'){
							$botao_loja1 = ' - LOJA HORIZONTE';
						}
					...
					$sql_aberto = mysqli_query($conn, "SELECT * FROM contas_pagar WHERE  (data_vencimento >= '$data_hoje' AND data_vencimento <= '$data_final') AND status='Em Aberto' AND id_empresa='$id_empresa'");
					...
					if(mysqli_num_rows($sql_aberto) > 0){
						...
						$total_aberto = number_format($total_aberto1, 2, ",", ".");
						
						
					}}
					
					$sql_vencidas = mysqli_query($conn, "SELECT * FROM contas_pagar WHERE (data_vencimento >= '$data_inicial' AND data_vencimento < '$data_hoje') AND status='Em Aberto' AND id_empresa='$id_empresa'");
					...
					$sql_pago = mysqli_query($conn, "SELECT * FROM contas_pagar WHERE  (data_vencimento >= '$data_inicial' AND data_vencimento <= '$data_final') AND status='Pago' AND id_empresa='$id_empresa'");
					...
					if(mysqli_num_rows($sql_pago) > 0){
						while($row_pago = mysqli_fetch_assoc($sql_pago)){
							...
							$total_pago = number_format($total_pago1, 2, ",", ".");

					}}
					
					$valor_total = $total_aberto1 + $total_vencido1 + $total_pago;
                            ...
                            <div class="col-xl-6">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-dollar-sign'></i> Contas a Pagar - <?php echo $mes.'/'.date('Y')?>
										<small>
											Período: <?php echo $data_inicial_br?> até <?php echo $data_final_br?> - <?php echo $botao_loja1?>
										</small>
									</h1>
								</div>
							</div>
								...
								<div class="card mb-2">
									<div class="card-body">
										<div class="d-flex flex-row align-items-center">
											...
											<div class="ml-3">
												<strong>
													<span style="font-size:24px;"><?php echo $total_aberto?></span>
												</strong>
												<br>
												<b>Contas a Vencer</b>
											</div>
								...
								<div class="card mb-2">
									<div class="card-body">
										<div class="d-flex flex-row align-items-center">
											...
											<div class="ml-3">
												<strong>
													<span style="font-size:24px"><?php echo $total_pago?></span>
												</strong>
												<br>
												<b>Contas Pagas</b>
											</div>
								...
								<div class="card mb-2">
									<div class="card-body">
										<div class="d-flex flex-row align-items-center">
											...
											<div class="ml-3">
												<strong>
													<span style="font-size:24px"><?php echo $valor_total2?></span>
												</strong>
												<br>
												<b>Valor Total</b>
											</div>
                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											$result_usuario = "SELECT * FROM contas_pagar WHERE (data_vencimento >= '$data_inicial' AND data_vencimento <= '$data_final') AND id_empresa='$id_empresa' ORDER BY data_vencimento DESC";
