	...
	<!-- PÁGINA 1 -->
		<div class="ibox-content p-xl break" style="border-radius:5px; border:#000000 2px solid;">
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">
						<img src="logos/<?php echo $logo?>" style="width:150px; heigth:auto" />
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-6" style="color:#000;">
					<div class="form-group">
						<p>Razão Social: <b>RMB RASTREIA MAIS BRASIL</b></p>
						<p>CNPJ: <b>42.202.950/0001-49</b></p>
						<p>Endereço: <b>AV DR CLAUDIO JOSE GUEIROS LEITE, 3444 - LOJA 23</b></p>
						</div>
				</div>
				<div class="col-md-6" style="color:#000;">
					<div class="form-group">
						<p>Telefone: <b>(81)99880-2625</b></p>
						<p>Bairro/Cidade: <b>JANGA, PAULISTA/PE</b></p>
					</div>
				</div>
			</div>
			<hr style="border:#000 1px solid;">	
			...
			<?php
					...
					$result_usuario = "SELECT * FROM veiculos_clientes WHERE id_cliente = '$id_cliente' AND id_veiculo='$id_veiculo' ORDER BY id_veiculo DESC";
			...
			<div class="row">
				...
				<div class="col-md-6" style="color:#000;">
					<div class="form-group">
						<p>Valor Mensal: <b><?php echo $valor_mensal?></b></p>
			...
			<div class="row">
				<div class="col-md-12 text-justify" style="color:#000;">
					<div class="form-group">
						<p>Horizonte, <?php echo date('d/m/Y')?></p>
		...
		<div class="ibox-content p-xl break" style="border-radius:5px; border:#000000 2px solid;">
			...
			<div class="row">
				<div class="col-md-12 text-justify" style="color:#000;">
					<div class="form-group">
						<p>Paulista, <?php echo $data_assinatura?></p>
