            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-car'></i> Deletar Dispositivo
										<small>
											Deletar historico de dispositivo
										</small>
									</h1>
								</div>
							</div>
                        ...
                        <form name="forml" id="forml" action="del_dispositivo.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											<div class="row">
												<div class="col-md-12">
													<label>Veículo:</label>
													<input type="text" class="form-control" name="veiculo" id="veiculo" value="<?php echo $veiculo?>" />
										   ...
										   <div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="modelo_equip" id="modelo_equip" value="<?php echo $modelo_equip?>" />
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
												...
												<div class="col-md-4">
													<div class="form-group">
														<label>Chip:</label>
														<input type="text" class="form-control" name="chip" id="chip" value="<?php echo $chip?>" />
													</div>
												</div>
											</div><br>
											<div class="row">
												<div class="col-md-12">
													<p>ATENÇÃO!!!! Todas as informações deste dispositivo serão excluídos.</p>
												</div>
											</div><br>
											<br>
											...
											<div class="row">
											   <div class="col-md-3">
													<div class="form-group">
														<button type="submit" id="botao" class="btn btn-info btn-sm">Limpar Dados</button>
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group">
