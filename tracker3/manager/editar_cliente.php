...
if($id_cliente_pai != '1361'){
	$cons_cliente_pai = mysqli_query($conn,"SELECT * FROM clientes WHERE id_cliente='$id_cliente_pai'");
		if(mysqli_num_rows($cons_cliente_pai) > 0){
			...
			$id_cliente_pai1 = $resp_cliente_pai['id_cliente'];
		}}
}
														...
														<select class="select2 form-control w-100" name="id_cliente_pai" id="id_cliente_pai"  required>
														  <option value="1361">RMB</option>
															<?php
																...
																$id_cliente1 = $res['id_cliente'];
																
																$nome_cliente22 = $res['nome_cliente'];
																echo '<option value="'.$id_cliente1.'">'.$nome_cliente22.'</option>';
																}
																}
																?>
														</select>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="telefone_residencial" id="telefone_residencial" autocomplete="off" onKeyUp="mascara( this, mtel );" maxlength="14" value="<?php echo $telefone_residencial?>" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<select class="select2 form-control w-100" name="dias_bloqueio" id="dias_bloqueio">
															<option value="<?php echo $dias_bloqueio?>"><?php echo $dias_bloqueio?> dias</option>
