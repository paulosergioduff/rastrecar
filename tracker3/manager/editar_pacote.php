...
$cons_pacote = mysqli_query($conn,"SELECT * FROM pacotes WHERE id_pacote='$id_pacote'");
	if(mysqli_num_rows($cons_pacote) > 0){
while ($resp_pacote = mysqli_fetch_assoc($cons_pacote)) {
$pacote = 	$resp_pacote['pacote'];
$valor = $resp_pacote['valor'];
              ...
              <aside class="page-sidebar" style="background-color:#FFF">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-dolly-flatbed'></i> Planos / Pacotes
									</h1>
								</div>
							</div>
                        ...
                        <form name="forml" id="forml" action="edit_pacote.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											<div class="row">
												<div class="col-md-4">
													<label>Nome Pacote:</label><br>
													<input class="form-control" name="pacote" id="pacote" type="text" value="<?php echo $pacote?>">
													<input class="form-control" name="id_pacote" id="id_pacote" type="hidden" value="<?php echo $id_pacote?>">
												</div>
											</div><br>
										   <div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input class="form-control" name="valor" id="valor" onkeypress="return(MascaraMoeda(this,'.',',',event))" value="<?php echo $valor?>" type="text">
													</div>
												</div>
											</div><br><br>
											...
											<div class="row">
											   <div class="col-md-3">
													<div class="form-group">
														<button type="submit" id="botao" class="btn btn-info btn-sm">Alterar</button>
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group">
														<a href="pacote.php"><button type="button" class="btn btn-dark btn-sm">Voltar</button></a>
													</div>
												</div>	
