                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="nivel" id="nivel" value="CLIENTE" readonly>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<label>Alertas pelo Whatsapp:</label><br>
													<div class="custom-control custom-switch" >
														<input type="checkbox" class="custom-control-input" name="whats" value="SIM" id="whats" <?php echo $alertas_whats?>>
														<label class="custom-control-label" for="whats"> </label>
													</div>
												</div>
												<div class="col-md-4">
											...
											<div class="row">
											   <div class="col-md-3">
													<div class="form-group">
														<button type="button" onclick="envia_3()" class="btn btn-success btn-sm" data-toggle="modal" data-target="#carregar" style="font-size:14px">Alterar</button>
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group">
									...
									<div class="modal-body">
										<div class="row">
											<div class="col-md-12">
												...
												<input type="hidden" id="origem" name="origem" value="USUARIO">
											</div>
										</div>
									...
									<div class="modal-body">
										<div class="row">
											<div class="col-md-12">
												...
												<input type="hidden" id="origem2" name="origem2" value="USUARIO">
											</div>
										</div>
...
function envia_3(){
	document.forml.action="edit_usuario_cli.php"
	document.forml.method = 'POST';
	document.forml.submit()
}
</script>
