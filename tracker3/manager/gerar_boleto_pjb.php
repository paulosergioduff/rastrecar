            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <form name="forml" id="forml" action="add/add_boleto_pjb.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											<h3><img src="/tracker3/Imagens/pjb.png" style="width:30px; heigth:auto;"> DADOS DO BOLETO - PJ Bank</h3>
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									...
									<div class="modal-footer justify-content-center">
										<a href="<?php echo $fat?>" target="_blank"><button type="button" class="btn btn-primary">Imprimir</button></a>
										<a href="cad_cliente.php?c=<?php echo $base64?>"><button type="button" class="btn btn-dark">fechar</button></a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									<div class="modal-body text-center font-18">
										...
										Não foi possível gerar o boleto. Por favor, verifique as informações digitadas.
									</div>
									<div class="modal-footer justify-content-center">
										<a href="<?php echo $fat?>" target="_blank"><button type="button" class="btn btn-primary">Imprimir</button></a>
										<a href="cad_cliente.php?c=<?php echo $base64?>"><button type="button" class="btn btn-dark">fechar</button></a>
