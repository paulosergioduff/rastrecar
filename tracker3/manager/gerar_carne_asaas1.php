            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <form name="forml" id="forml" action="add/add_carne_asaas.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											<h3><img src="/tracker3/Imagens/asaas.jpg" style="width:30px; heigth:auto;"> DADOS DO CARNÊ - ASAAS</h3>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="hidden" class="form-control" name="banco" id="banco" value="2">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<select class="select2 form-control" name="parcelas" id="parcelas" required>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="desconto" id="desconto" value="5,00" onkeypress="return(MascaraMoeda(this,'.',',',event))" required>
													</div>
												</div>
											</div>
											...
											<div class="row">
											   <div class="col-md-3">
													<div class="form-group">
														<button type="submit" id="botao" class="btn btn-info btn-sm">Gerar Carnê</button>
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group">
