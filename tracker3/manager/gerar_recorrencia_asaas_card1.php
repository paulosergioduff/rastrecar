...
$cons_veiculos = mysqli_query($conn,"SELECT * FROM veiculos_clientes WHERE id_veiculo IN ($veic)");
	if(mysqli_num_rows($cons_veiculos) > 0){
while ($resp_veiculos = mysqli_fetch_assoc($cons_veiculos)) {
$placa[] = 	$resp_veiculos['placa'].'-'.$resp_veiculos['marca_veiculo'].'/'.$resp_veiculos['modelo_veiculo'];
$valor_mensal += 	$resp_veiculos['valor_mensal'];
$valor_mensal = number_format($valor_mensal, 2, ",", ".");

	}}
	$placas = implode(", ", $placa);
            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <form name="forml" id="forml" action="add/add_recorrencia_asaas_card.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											<h3><img src="/tracker3/Imagens/asaas.jpg" style="width:30px; heigth:auto;"> DADOS DA ASSINATUTA ASAAS</h3>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="hidden" class="form-control" name="banco" id="banco" value="5">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
												...
												<div class="col-md-4">		
													<div class="form-group" id="data_1">
														<label>Primeiro Vencimento: <i class="fas fa-info-circle" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Todas as cobranças serão geradas com o mesmo dia. Ex: Primeira mensalidade em 13/01/2022. As demais serão todo dia 13." data-original-title="Vencimento"></i></label>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label>Valor Mensal: <i class="fas fa-info-circle" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Somatório dos valores dos veículos selecionados" data-html="true" data-original-title="Valor Mensal"></i></label>
														<div id="retorno_pacote">
														<input type="text" class="form-control" name="valor" id="valor" value="<?php echo $valor_mensal?>" onkeypress="return(MascaraMoeda(this,'.',',',event))" required>
														</div>
													</div>
												</div>
												<div class="col-md-4">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="juros" id="juros" value="10,00" onkeypress="return(MascaraMoeda(this,'.',',',event))" required>
													</div>
												</div>
											</div><br>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label>Descrição: <i class="fas fa-info-circle" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Informação que será impressa nos itens da fatura." data-original-title="Descrição"></i></label>
														<input type="text" class="form-control" name="descricao" id="descricao" value="MENSALIDADE RASTREAMENTO" required>
													</div>
												</div>
												<!--
												<div class="col-md-4">
													<div class="form-group">
														<label>Gerar Cobrança em quantos dias antes do vencimento: </label>
														<select class="select2 form-control" name="dias_cobranca" id="dias_cobranca" required>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<select class="select2 form-control" name="termino_recorrencia" id="termino_recorrencia" required>
															
															<option value="6">06 meses</option>
															<option value="12">12 meses</option>
															<option value="18">18 meses</option>
															<option value="24">24 meses</option>
															<option value="99">Indeterminado</option>
														</select>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														...
														<select class="select2 form-control" name="forma_pagamento" id="forma_pagamento" required>
															<option value="BOLETO">Boleto Bancario</option>
															<option value="CREDIT_CARD">Cartao de Credito/Debito</option>
															<option value="UNDEFINED">A Escolha do Cliente</option>
														</select>
													</div>
												</div>
											</div><BR>
											
											<input type="hidden" class="form-control" name="id_veiculo" id="id_veiculo" value="<?php echo $veic?>">
											...
											<input type="hidden" class="form-control" name="id_assinatura" id="id_assinatura" value="0" required>
											...
											<div class="row">
											   <div class="col-md-3">
													<div class="form-group">
														<button type="submit" id="botao" class="btn btn-info btn-sm">Gerar Recorrência</button>
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group">
