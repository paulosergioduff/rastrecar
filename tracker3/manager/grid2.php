                    ...
                    <?php include('include/head.php');
						...
						if($acesso == 'GERAL'){
							...
							$botao_loja2 = '<div id="floating-panel9">				
													<a href="grid.php"><button type="button" class="btn btn-info btn-sm shadow-0" style="font-size:13px; top:0; width:150px; color:#000"><i class="fal fa-home"></i> Loja Horizonte</button></a>							
												</div>';
						}
						if($id_empresa == '1361'){
							$botao_loja1 = ' - LOJA HORIZONTE';
...
$cont_veiculos = mysqli_query($conn,"SELECT * FROM tc_devices WHERE contact !='ESTOQUE' AND id_empresa='$id_empresa'");
...
$result_markers = "SELECT * FROM tc_devices WHERE contact !='ESTOQUE' AND id_empresa='$id_empresa'";
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											<div id="floating-panel8" data-toggle="modal" data-target="#rel_desc">
												...
												<div class="row bg-white" style="border-radius:5px; border:#CCC 2px solid; color:#000; width:130px;" data-toggle="tooltip" data-placement="bottom" data-offset="0,10" data-original-title="Veículos Offline - Clique para abrir">
													<div class="col-md-6 text-left" >
...
<script>
  function att_veiculos(){
	...
	$.post('include/grid_veiculos_col2.php?customer='+customer, function(grid_veiculos){
...
center: [-38.49537333333333, -4.0949366666666664],
zoom: 9,
...
function refreshMap(){
  ...
  downloadUrl('resultado2.php?id_empresa='+id_empresa, (data) => {
