                ...
                <div class="modal-content">
                    <div class="dropdown-header bg-trans-gradient d-flex justify-content-center align-items-center w-100">
                        <h4 class="m-0 text-center color-white">
                            ...
                            <small class="mb-0 opacity-80">Configurações do usuário</small>
                        </h4>
                    ...
                    <div class="modal-body p-0">
                        <div class="settings-panel">
                            ...
                            <div class="list" id="fh">
                                ...
                                <span class="onoffswitch-title">Fixar Cabeçalho</span>
                                <span class="onoffswitch-title-desc">Topo da página sempre fixo</span>
                            </div>
                            <div class="list" id="nff">
                                <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-function-fixed" checked=""></a>
                            ...
                            <div class="pl-5 pr-3 py-3 bg-faded">
                                <div class="row no-gutters">
                                    <div class="col-6 pr-1">
                                        <a href="#" class="btn btn-outline-dark fw-500 btn-block" data-action="app-reset">Reset Settings</a>
                                    </div>
