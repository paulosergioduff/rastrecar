...
<html lang="en">
    ...
    <body class="mod-bg-1 nav-function-fixed header-function-fixed">
						...
						<div class="modal-dialog modal-dialog-centered modal-xl">
							<div class="modal-content">
								...
								<div class="modal-body pos-center">
									...
									$result_usuario = "SELECT * FROM clientes WHERE status='2' WHERE id_empresa='$id_empresa'";
							...
							$status1 = '<h5><span class="badge" style="background-color:#CD5C5C;color:#FFF;">BLOQUEADO</span></h5>';
								}
							...
							$botao = '<a href="cad_cliente.php?c='.$base64.'" target="_blank"><button type="button" class="btn btn-dark btn-icon btn-sm" data-toggle="tooltip" title="Abrir Cadastro"><i class="fab fa-elementor"></i></button></a>';
							?>
							<tr>
									<td><span style="color:#990000"><b><?php echo $row_usuario['nome_cliente']; ?></b></span></td>
									<td><b><?php echo $total_veic; ?> Veículo(s)</b></td>
		...
		$cons_mes_atual = mysqli_query($conn,"SELECT * FROM veiculos_clientes WHERE MONTH(data_cadastro) = '$mes_atual' AND YEAR(data_cadastro) = '$ano_atual' AND status='1' ORDER BY data_cadastro DESC");
		...
		$cons_mes_2 = mysqli_query($conn,"SELECT * FROM veiculos_clientes WHERE MONTH(data_cadastro) = '$mes_2' AND YEAR(data_cadastro) = '$ano_2' AND status='1' AND id_empresa='$id_empresa' ORDER BY data_cadastro DESC");
		...
		$cons_mes_3 = mysqli_query($conn,"SELECT * FROM veiculos_clientes WHERE MONTH(data_cadastro) = '$mes_3' AND YEAR(data_cadastro) = '$ano_3' AND status='1' AND id_empresa='$id_empresa' ORDER BY data_cadastro DESC");
		...
		$cons_mes_4 = mysqli_query($conn,"SELECT * FROM veiculos_clientes WHERE MONTH(data_cadastro) = '$mes_4' AND YEAR(data_cadastro) = '$ano_4' AND status='1' AND id_empresa='$id_empresa' ORDER BY data_cadastro DESC");
		...
		$cons_mes_5 = mysqli_query($conn,"SELECT * FROM veiculos_clientes WHERE MONTH(data_cadastro) = '$mes_5' AND YEAR(data_cadastro) = '$ano_5' AND status='1' AND id_empresa='$id_empresa'  ORDER BY data_cadastro DESC");
		...
		$cons_mes_6 = mysqli_query($conn,"SELECT * FROM veiculos_clientes WHERE MONTH(data_cadastro) = '$mes_6' AND YEAR(data_cadastro) = '$ano_6' AND status='1' AND id_empresa='$id_empresa' ORDER BY data_cadastro DESC");
