            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper ">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-users'></i> Novo Cliente
										<small>
                        ...
                        <form name="forml" id="forml" action="add/add_cliente.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<select class="select2 form-control w-100" name="id_cliente_pai" id="id_cliente_pai"  required>
														  <option value="1361">RMB</option>
															<?php
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="nome_cliente" autocomplete="off" id="nome_cliente" class="form-control text-uppercase" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label>CPF/CNPJ:</label>
														<input type="text" name="doc_cliente" autocomplete="off" id="doc_cliente" class="form-control" onkeypress='mascaraMutuario(this,cpfCnpj)' onblur='clearTimeout()' maxlength="18" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label>RG/Inscrição Estadual:</label>
														<input type="text" name="rg_cliente" autocomplete="off" id="rg_cliente" class="form-control">
													</div>
												</div>
											</div><br>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="data_nascimento" autocomplete="off" id="data_nascimento" class="form-control" onKeyPress="mascaraData(this)" maxlength="10" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="telefone_residencial" id="telefone_residencial" autocomplete="off" onKeyUp="mascara( this, mtel );" maxlength="14" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="telefone_outros" id="telefone_outros" autocomplete="off" onKeyUp="mascara( this, mtel );" maxlength="15" class="form-control">
													</div>
												</div>
											</div><br>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="senha_atendimento" id="senha_atendimento" autocomplete="off" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label>Bloqueio por Inadimpência:</label>
														<select class="select2 form-control w-100" name="dias_bloqueio" id="dias_bloqueio">
											...
											<div class="row">
											   <div class="col-md-3">
													<div class="form-group">
														<button type="submit" class="btn btn-info btn-sm">Cadastrar Cliente</button>
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group">
											...
											<input type="hidden" name="vendedor" id="vendedor" value="<?php echo $user_nome?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
