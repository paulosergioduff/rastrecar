        ...
        <div class="page-wrapper">
            <div class="page-inner">
               ...
               <aside class="page-sidebar" style="background-color:#FFF">
					...
					$hora_final = date('H:i');
					$date_final = $date_final.'T'.$hora_final;
					
					$date_inicial = date('Y-m-d');
					$hora_inicial = '00:00';
					$date_inicial = $date_inicial.'T'.$hora_inicial;
					?>
                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											<div class="row">
												<div class="col-md-3">
													<div class="form-group" id="data_1">
														...
														<input type="datetime-local" class="form-control" name="data_inicial" id="data_inicial" value="<?php echo $date_inicial?>" autocomplete="off" type="text" required>
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group" id="data_1">
														<label class="font-normal">Data Final:</label>
														<input type="datetime-local" class="form-control" name="data_final" id="data_final" value="<?php echo $date_final?>" autocomplete="off" type="text" required>
													</div>
												</div>
											...
											<div class="panel-hdr">
												<h5>
												   Para cálculo de consumo, digite as informações abaixo:
												</h5>	
											</div>
											<hr>
											<div class="row">
												<div class="col-md-3">
													<div class="form-group" id="data_1">
														<label class="font-normal">Valor Combustível: <small><i>R$ por litro</i></small></label>
														<input type="text" class="form-control" name="valor_comb" id="valor_comb" autocomplete="off" onkeypress="return(MascaraMoeda(this,'.',',',event))">
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group" id="data_1">
														<label class="font-normal">Consumo Médio: <small><i>km por litro</i></small></label>
														<input type="number" class="form-control" name="km_litro" id="km_litro" autocomplete="off">
													</div>
												</div>	
											</div><br><br>
											<div class="row">
