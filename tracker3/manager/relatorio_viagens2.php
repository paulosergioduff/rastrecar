											...
											<div class="row">
												...
												<?php
													...
													curl_setopt_array($curl, array(
													  CURLOPT_URL => 'http://5.189.185.179:8082/api/reports/trips?from=2021-11-03T00:00:00Z&to=2021-11-03T16:30:00Z&deviceId=12',
													...
													foreach($json as $registro):
														$startPositionId = $registro->startPositionId;
														$averageSpeed = $registro->averageSpeed;
														$maxSpeed = $registro->maxSpeed;
														$vel_media = $averageSpeed * 1.609;
														$vel_media = round($vel_media);
														
														$vel_maxima = $maxSpeed * 1.609;
														$vel_maxima = round($vel_maxima);

														$startTime = $registro->startTime;
														$hora_inicial  =  date('d/m/Y H:i:s', strtotime($startTime));
														$endTime = $registro->endTime;
														$hora_final  =  date('d/m/Y H:i:s', strtotime($endTime));
														$end_inicial = $registro->startAddress;
														$end_final = $registro->endAddress;
														$distance = $registro->distance;
														$distance = $distance / 1000;
														$distance = round($distance);
														

														 $date_time  = new DateTime($startTime);
														 $diff       = $date_time->diff( new DateTime($endTime));
														 $tempo = $diff->format('%Hh %imin');
									 ...
									 <div class="form-group">
										<div class="row">
											<div class="col-md-3">
												...
												<i class="far fa-clock"></i> <?php echo $hora_inicial?>
											</div>
											<div class="col-md-7">
												<label><b>Endereço Inicial</b></label><br>
												<i class="fas fa-map-marker-alt"></i> <?php echo $end_inicial?>
											</div>
										...
										<div class="row">
											<div class="col-md-3">
												...
												<i class="far fa-clock"></i> <?php echo $hora_final?>
											</div>
											<div class="col-md-7">
												<label><b>Endereço Final</b></label><br>
												<i class="fas fa-map-marker-alt"></i> <?php echo $end_final?>
											</div>
										</div>
										<hr>
										<div class="row">
											<div class="col-md-3">
												...
												<i class="fas fa-road"></i> <?php echo $distance?> km rodados
											</div>
											<div class="col-md-3">
												<label><b>Tempo Percurso:</b></label><br>
												<i class="fas fa-history"></i> <?php echo $tempo?>
											</div>
											<div class="col-md-3">
												<label><b>Velocidade Média:</b></label><br>
												<i class="fas fa-tachometer-alt"></i> <?php echo $vel_media?> km/h
											</div>
											<div class="col-md-3">
