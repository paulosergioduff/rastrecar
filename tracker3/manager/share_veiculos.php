              ...
              <aside class="page-sidebar" style="background-color:#FFF">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-share-alt'></i> Compartilhar Veiculo
                        ...
                        <form name="forml" id="forml" action="edit_share.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											<div class="row">
												<div class="col-md-4">
													<label>Veículo</label>
													<input type="text" class="form-control" name="veiculo" id="veiculo" value="<?php echo $veiculo?>" readonly>
													<input type="hidden" class="form-control" name="deviceid" id="deviceid" value="<?php echo $deviceid?>" />
													<input type="hidden" class="form-control" name="id_veiculo" id="id_veiculo" value="<?php echo $id_veiculo?>" />
										   ...
										   <div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<select class="select2-placeholder-multiple form-control" multiple="multiple" name="usuarios[]" id="usuarios">
														<?php
																						
														$cons_veic = mysqli_query($conn,"SELECT * FROM usuarios WHERE id_empresa='1361' AND ativo='SIM' ORDER BY nome ASC");
														if(mysqli_num_rows($cons_veic) <= 0){
														echo '<option value="0">Nenhum Cliente Encontrado</option>';
														}else{
														
														while ($res_veic = mysqli_fetch_assoc($cons_veic)) {
														$id_usuarios = $res_veic['id_usuarios'];
														$nome = $res_veic['nome'];
														echo '<option value="'.$id_usuarios.'">'.$nome.'</option>';
														}
														}
														?>
													</select>
											...
											$result_usuario = "SELECT * FROM usuarios WHERE id_usuarios IN ($share) ORDER BY nome ASC";
											...
											?>
												<tr>
													...
													<td>
													  <a href="del_share.php?id_usuarios=<?php echo $id_usuarios?>&deviceid=<?php echo $deviceid?>"><button type="button" class="btn btn-icon btn-danger btn-sm" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="Remover"><i class="fal fa-trash"></i></button></a>
													</td>
												</tr>
