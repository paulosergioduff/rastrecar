                    ...
                    <main id="js-page-content" role="main" class="page-content">
						...
						<div class="row">
                            <div class="col-xl-6">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-users'></i> Usuários
										<small>
							...
							<div class="col-xl-6 text-right">
								<a href="novo_user_oper.php"><button type="button" class="btn btn-primary btn-sm"><i class="fal fa-user"></i> Novo Operador</button></a>
								<a href="novo_user_adm.php"><button type="button" class="btn btn-primary btn-sm"><i class="fal fa-user"></i> Novo Usuário Funcionario</button></a>
                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											$result_usuario = "SELECT * FROM usuarios WHERE nivel != '2' ORDER BY id_usuarios ASC";
											...
											if($nivel == 5){
												$nivel1 = 'MASTER';
												$botao = ' <a href="editar_usuario_oper.php?c='.$base_user.'"><button type="button" class="btn btn-icon btn-outline-dark btn-sm" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="Abrir Cadastro"><i class="fas fa-search"></i></button></a>';
											}
											...
											?>
												<tr>
													...
													<td><span class="text-dark"><?php echo $cargo; ?></span></td>
