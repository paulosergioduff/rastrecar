											...
											<div class="row">
														...
														<select class="select2 form-control w-100" name="cliente_pai" id="cliente_pai"  required>
														  ...
														  <option value="1361">RMB</option>
															<?php
																...
																$cons_parceiro = mysqli_query($conn,"SELECT * FROM clientes WHERE cliente_pai='SIM' ORDER BY nome_cliente ASC");
												...
												<div class="col-md-8">
													<div class="form-group">
														...
														<select class="select2-placeholder-multiple form-control" multiple="multiple" name="cliente[]" id="cliente"  required>
														  <option value="">Selecione</option>
															<?php
																
																$cons_parceiro1 = mysqli_query($conn,"SELECT * FROM clientes WHERE id_cliente_pai='1361' ORDER BY nome_cliente ASC");
																if(mysqli_num_rows($cons_parceiro1) <= 0){
																echo '<option value="0">Nenhum Cliente Encontrado</option>';
																}else{
																echo '<option value="1">Selecionar Todos</option>';
																while ($res2 = mysqli_fetch_assoc($cons_parceiro1)) {
																$id_cliente2 = $res2['id_cliente'];
																
																$nome_cliente2 = $res2['nome_cliente'];
																echo '<option value="'.$id_cliente2.'">RMB > '.$nome_cliente2.'</option>';
																}
																}
																?>
														</select>
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="date" class="form-control" name="data_inicial" id="data_inicial" autocomplete="off" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label class="font-normal">Data Final:</label>
														<input type="date" class="form-control" name="data_final" id="data_final" autocomplete="off"  required>
													</div>
												</div>
