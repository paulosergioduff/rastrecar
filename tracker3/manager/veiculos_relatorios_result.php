                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											<h3>
											<a href="excel/veiculos_relatorio.php?data_inicial=<?php echo $data_inicial?>&data_final=<?php echo $data_final?>&cliente=<?php echo $clientes?>&equipamentos=<?php echo $equipamentos?>&cliente_pai=<?php echo $cliente_pai?>"><button type="button" class="btn btn-success btn-sm shadow-0"><i class="fas fa-file-excel"></i> Excel</button></a> 
											<a href="pdf_files/veiculos_relatorio.php?data_inicial=<?php echo $data_inicial?>&data_final=<?php echo $data_final?>&cliente=<?php echo $clientes?>&equipamentos=<?php echo $equipamentos?>&cliente_pai=<?php echo $cliente_pai?>" target="_blank"><button type="button" class="btn btn-sm shadow-0" style="background-color:#CD5C5C; color:#FFF"><i class="fas fa-file-pdf"></i> PDF</button></a>
											<a href="veiculos_relatorios.php"><button type="button" class="btn btn-primary btn-sm shadow-0"><i class="fas fa-file"></i> Novo Relatório</button></a>
											</h3>
  ...
  $('#carregar').modal('show');
	...
	$(function(){
	  $("select[name=cliente_pai]").change(function(){
	    beforeSend:$("select[name='cliente[]']").html('<option value="">Carregando...</option>')
	...
	$(function(){
	  $("select[name='cliente[]']").change(function(){
	    beforeSend:$("select[name=equipamentos]").html('<option value="">Carregando...</option>')
