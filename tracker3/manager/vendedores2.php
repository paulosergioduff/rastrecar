        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
					...
					if($acesso == 'GERAL'){
						$botao_loja1 = '';
						$botao_loja2 = '<a href="vendedores.php"><button type="button" class="btn btn-dark btn-sm" style="font-size:14px"><i class="fal fa-home"></i> Loja Horizonte</button></a>';
                    ...
                    <main id="js-page-content" role="main" class="page-content">
						...
						<div class="row">
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-users'></i> Vendedores - LOJA FORTALEZA
										<small>
							...
							<a href="novo_vendedor.php?c=1362"><button type="button" class="btn btn-info btn-sm" style="font-size:14px"><i class="fal fa-user-plus"></i> Novo Vendedor</button></a>
							</div>
						</div>
                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											$result_usuario = "SELECT * FROM vendedores WHERE id_empresa='1362' ORDER BY id_vendedor DESC";
