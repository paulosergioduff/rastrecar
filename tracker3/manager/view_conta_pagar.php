            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <form name="forml" id="forml" action="baixar_conta_pagar.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                        ...
                                        <div class="panel-content">
											<div class="row">
												...
												<div class="col-md-8 text-right">
													<a href="editar_conta_pagar.php?c=<?php echo $base64?>"><button type="button" class="btn btn-dark btn-sm"><i class="fal fa-edit"></i> Editar</button></a>
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="user_baixa" id="user_baixa" value="<?php echo $user_baixa?>" readonly>							
													</div>
												</div>                                   
											</div><br>
											<div class="row">
