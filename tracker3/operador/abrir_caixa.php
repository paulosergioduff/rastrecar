               ...
               <aside class="page-sidebar" style="background-color:#14145A">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-car'></i> Caixa - <?php echo $botao_loja1?>
										<small>
                        ...
                        <form name="forml" id="forml" action="add/add_caixa.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
											 ...
											 <div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="hidden" class="form-control" name="data_inicial" id="data_inicial" value="<?php echo $date?>" >
														<input type="hidden" class="form-control" name="user_inicio" id="user_inicio" value="<?php echo $user_nome?>" >
														<input type="hidden" class="form-control" name="status" id="status" value="ABERTO" >
												...
												<div class="col-md-4">
													<div class="form-group">
														<label>Loja:</label>
														<input type="text" class="form-control" value="<?php echo $botao_loja1?>" readonly>
													</div>
												</div>
											</div><BR>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<div id="retorno_valor">
														<input type="text" class="form-control" name="valor_inicial" id="valor_inicial" onkeypress="return(MascaraMoeda(this,'.',',',event))" required>
														</div>
													</div>
												</div>
