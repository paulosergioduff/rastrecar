...
$id_cliente_pai = $_REQUEST['id_cliente_pai'];
...
$sql = mysqli_query($conn, "INSERT INTO cerca_virtual (geofenceid, id_cliente, id_cliente_pai, endereco, latitude, longitude, radius, nome_cerca, data_criacao, area, tipo) VALUES ('$id', '$id_cliente', '$id_cliente_pai', '$endereco', '$latitude', '$longitude', '$radius_size', '$nome_cerca', '$data_criacao', '$coordenadas1', '$tipo_cerca')");
