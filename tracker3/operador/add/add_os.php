...
$sql = mysqli_query($conn, "INSERT INTO ordem_servico (data_criacao, id_cliente, id_veiculo, id_empresa, parceiro, status, tipo_os, prioridade, descricao, imei, chip, valor_instalacao, id_cliente_pai) VALUES ('$data_criacao', '$id_cliente', '$id_veiculo', '$id_empresa', '$parceiro', '$status', '$tipo_os', '$prioridade', '$descricao', '$imei', '$chip', '$valor_instalacao', '$id_cliente_pai')");
