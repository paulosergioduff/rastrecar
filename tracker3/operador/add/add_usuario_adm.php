...
$sql = mysqli_query($conn, "INSERT INTO usuarios (nome, usuario, nivel,  email, ativo, cargo, senha, acesso, id_empresa) VALUES ('$nome', '$usuario', '$nivel',  '$email', '$ativo', '$cargo', '$senha', '$acesso', '$id_empresa')");
