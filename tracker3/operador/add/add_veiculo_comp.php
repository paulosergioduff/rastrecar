...
if($deviceid != ''){
	$sql_veiculo = mysqli_query($conn, "INSERT INTO veiculos_clientes (data_cadastro, status, id_cliente, id_empresa, marca_veiculo, tipo_veiculo, modelo_veiculo, ano_veiculo, ano_modelo, placa, renavan, chassi, combustivel, cor_veiculo, chip, operadora, fornecedor_chip, iccid, imei, modelo_equip, deviceid, alerta_ign, alerta_bateria, alerta_bateria_baixa, alerta_movimento, alerta_vibracao, alerta_panico, alerta_voltagem, pacote, valor_mensal, forma_pagamento, vendedor, vencimento_contrato, id_cliente_pai) VALUES ('$data_cadastro', '$status', '$id_cliente', '$id_empresa', '$marca_veiculo', '$tipo_veiculo', '$modelo_veiculo', '$ano_veiculo', '$ano_modelo', '$placa', '$renavan', '$chassi', '$combustivel', '$cor_veiculo', '$chip', '$operadora', '$fornecedor_chip', '$iccid', '$imei', '$modelo_equip', '$deviceid', '$ignicao1', '$bateria_removida1', '$bateria_baixa1', '$movimento1', '$vibracao1', '$panico1', '$voltagem1', '$pacote', '$valor_mensal', '$forma_pagamento', '$vendedor', '$vencimento_contrato', '$id_cliente_pai')");
