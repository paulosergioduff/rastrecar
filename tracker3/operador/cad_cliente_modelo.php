                                    ...
                                    <div class="row no-gutters row-grid">
                                        <div class="col-12">
                                            <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                                <img src="/tracker3/app-assets/img/demo/avatars/profile_small.png" class="rounded-circle shadow-2 img-thumbnail" alt="">
                                        ...
                                        <div class="col-6">
										 ...
										 <div class="col-12">
                                            <div class="p-3 text-center">
											  ...
											  <button type="button" class="btn btn-dark btn-sm" style="width:90%"><i class="fal fa-file-edit"></i> Ordens de Serviço</button><br><br>
											   ...
											   <a href="cad_cliente_acesso.php?c=<?php echo $base64_cliente?>"><button type="button" class="btn btn-outline-dark btn-sm" style="width:90%" onclick="carrega()"><i class="fal fa-sign-in-alt"></i> Acesso Web/App</button></a><br><br>
												<a href="cad_cliente_conf.php?c=<?php echo $base64_cliente?>"><button type="button" class="btn btn-outline-dark btn-sm" style="width:90%" onclick="carrega()"><i class="fal fa-cogs"></i> Conf. Sistema</button></a><br><br>
												<?php echo $botao_del?>
                                            </div>
