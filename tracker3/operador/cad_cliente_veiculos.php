                ...
                <!-- BEGIN Left Aside -->
                 <aside class="page-sidebar" style="background-color:#FFF">
                    ...
                    <?php include('include/sidebar.php');
						if($cad_equip == 'SIM'){
							$novo_veiculo = 'novo_veiculo_comp.php';
						}
						if($cad_equip != 'SIM'){
							$novo_veiculo = 'novo_veiculo.php';
						}
					?>
					...
					<form name="forml" id="forml">
                        ...
                        <div class="row">
                                        ...
                                        <div class="panel-content">
											<div class="row">
												...
												<div class="col-md-6 text-right">
													<a href="<?php echo $novo_veiculo?>?c=<?php echo $base_cliente?>"><button type="button" class="btn btn-success btn-sm"><i class="fal fa-car"></i> Novo Veículo</button></a>
												</div>
											</div>
							...
							if($lastupdate <= $data_inicial_12){
								...
								$botao_mapa = '<a href="grid_device.php?c='.$device_id.'" target="_blank"><button class="dropdown-item" type="button"><i class="fal fa-map-marker-alt"></i> Abrir no mapa</button></a>';
							} 
							if($lastupdate > $data_inicial_12){
