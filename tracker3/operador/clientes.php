...
<html lang="en">
    ...
    <body class="mod-bg-1 nav-function-fixed header-function-fixed">
        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <div class="page-content-wrapper ">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-users'></i> Clientes
										<small>
                    ...
                    <!-- END Page Footer -->
                    <!-- BEGIN Shortcuts -->
                   <input type="hidden" id="id_cliente_pai" value="<?php echo $id_cliente10?>">
                </div>
            </div>
        </div>
        <!-- END Page Wrapper -->
        ...
        $(document).ready(function(){
			var id_cliente_pai = document.getElementById("id_cliente_pai").value;
            ...
            $('#dt-basic-example').DataTable({
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url':'include/list_clientes.php?id='+id_cliente_pai
                },
                'columns': [
                    { data: 'nome_cliente' },
