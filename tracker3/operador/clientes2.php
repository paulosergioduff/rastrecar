    ...
    <body class="mod-bg-1 nav-function-fixed">
            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper ">
					...
					if($acesso == 'GERAL'){
						...
						$botao_loja2 = '<a href="clientes.php"><button type="button" class="btn btn-dark btn-sm shadow-0" style="font-size:14px"><i class="fal fa-home"></i> Loja Horizonte</button></a>';
        ...
        $(document).ready(function(){
            $('#dt-basic-example').DataTable({
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url':'include/list_clientes2.php'
                },
                'columns': [
                    { data: 'nome_cliente' },
