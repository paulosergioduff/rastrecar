                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											<div class="row">
												...
												<div class="col-md-2">
													<div class="form-group">
														<label>Clientes Bloqueados:</label>
														<div class="custom-control custom-switch" >
															<input type="checkbox" class="custom-control-input" name="bloqueados" id="bloqueados" value="SIM">
															<label class="custom-control-label" for="bloqueados" > </label>
														</div>
													</div>
												</div>
												<div class="col-md-2">
