                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <?php include('include/head.php');
						...
						if($acesso == 'GERAL'){
							...
							$botao_loja2 = '<a href="contas_receber.php"><button type="button" class="btn btn-dark btn-sm" style="font-size:14px"><i class="fal fa-home"></i> Loja Horizonte</button></a>';	
						}
						if($id_empresa == '1361'){
							$botao_loja1 = ' - LOJA HORIZONTE';
						}
					...
					$sql_aberto = mysqli_query($conn, "SELECT * FROM contas_receber WHERE  (data_vencimento >= '$data_hoje' AND data_vencimento <= '$data_final') AND status='Em Aberto' AND id_empresa='$id_empresa'");
					...
					$sql_pago = mysqli_query($conn, "SELECT * FROM contas_receber WHERE  (data_vencimento >= '$data_inicial' AND data_vencimento <= '$data_final') AND status='Pago' AND id_empresa='$id_empresa'");
                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											$result_usuario = mysqli_query($conn,"SELECT * FROM contas_receber WHERE (data_vencimento >= '$data_inicial' AND data_vencimento <= '$data_final') AND id_empresa='$id_empresa' ORDER BY data_vencimento DESC");
