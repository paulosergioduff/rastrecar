                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <?php include('include/head.php');
						...
						if($acesso == 'GERAL'){
							...
							$botao_loja2 = '<a href="contas_receber_vencidas.php"><button type="button" class="btn btn-dark btn-sm" style="font-size:14px"><i class="fal fa-home"></i> Loja Horizonte</button></a>';	
						}
						if($id_empresa == '1361'){
							$botao_loja1 = ' - LOJA HORIZONTE';
						}
