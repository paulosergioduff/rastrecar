...
$id_instalador = $cliente[1];



$cons_vendedor = mysqli_query($con,"SELECT * FROM parceiros WHERE id_parceiro='$id_instalador'");
	if(mysqli_num_rows($cons_vendedor) > 0){
		while ($resp_vendedor = mysqli_fetch_assoc($cons_vendedor)) {
		$nome_instalador = $resp_vendedor['nome_parceiro'];
		$telefone_celular = $resp_vendedor['celular'];
		...
		$doc_instalador = $resp_vendedor['documento'];
		$email = $resp_vendedor['email'];
		
		$vlr_inst_bloqueio = $resp_vendedor['vlr_inst_bloqueio'];
		$vlr_inst_bloqueio = number_format($vlr_inst_bloqueio, 2, ",", ".");
		
		$vlr_inst = $resp_vendedor['vlr_inst'];
		$vlr_inst = number_format($vlr_inst, 2, ",", ".");
		
		$vlr_manutencao = $resp_vendedor['vlr_manutencao'];
		$vlr_manutencao = number_format($vlr_manutencao, 2, ",", ".");
		
		$vlr_retirada = $resp_vendedor['vlr_retirada'];
...
$cons_user_ven = mysqli_query($con,"SELECT * FROM usuarios WHERE id_instalador='$id_instalador'");
            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed"">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-users'></i> Alterar Instalador
										<small>
											Alteração de Cadastro de Instaladores
										</small>
									</h1>
								</div>
							</div>
                        ...
                        <form name="forml" id="forml" action="edit_instalador.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="nome_instalador" autocomplete="off" id="nome_instalador" value="<?php echo $nome_instalador?>" class="form-control text-uppercase" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label>CPF/CNPJ:</label>
														<input type="text" name="doc_instalador" autocomplete="off" id="doc_instalador" class="form-control" value="<?php echo $doc_instalador?>" onkeypress='mascaraMutuario(this,cpfCnpj)' onblur='clearTimeout()' maxlength="18" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label>Valor Instalação com Bloqueio:</label>
														<input type="text" name="vlr_inst_bloqueio" id="vlr_inst_bloqueio" onkeypress="return(MascaraMoeda(this,'.',',',event))" value="<?php echo $vlr_inst_bloqueio?>" autocomplete="off" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label>Valor Instalação sem Bloqueio:</label>
														<input type="text" name="vlr_inst" id="vlr_inst" onkeypress="return(MascaraMoeda(this,'.',',',event))" value="<?php echo $vlr_inst?>" autocomplete="off" class="form-control">
													</div>
												</div>
											</div><br>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="vlr_manutencao" id="vlr_manutencao" onkeypress="return(MascaraMoeda(this,'.',',',event))" value="<?php echo $vlr_manutencao?>" autocomplete="off" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label>Valor Retirada:</label>
														<input type="text" name="vlr_retirada" id="vlr_retirada" onkeypress="return(MascaraMoeda(this,'.',',',event))" value="<?php echo $vlr_retirada?>" autocomplete="off" class="form-control">
													</div>
												</div>
											</div><br><br>
											...
											<div class="row">
												...
												<div class="col-md-4">
													<label>Status Instalador:</label><br>
													 <div class="custom-control custom-switch">
														<input type="checkbox" class="custom-control-input" id="status_instalador" onchange="status_vend();" name="status_instalador" value="SIM" <?php echo $status1?> >
														<label class="custom-control-label" for="status_instalador" id="status_instalador1"><?php echo $status3?></label>
													</div>
												</div>
											</div><br><br>
											...
											<div class="row">
											   <div class="col-md-3">
													<div class="form-group">
														<button type="submit" id="botao" class="btn btn-info btn-sm">Alterar Instalador</button>
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group">
														<a href="instaladores.php"><button type="button" class="btn btn-dark btn-sm">Voltar</button></a>
													</div>
												</div>	
													  
											</div>
											<input type="hidden" name="customer_sales" id="customer_sales" value="<?php echo $id_instalador?>">
...
function status_vend(){
	//var bateria_removida = document.getElementById("bateria_removida").value;
	 if(status_instalador.checked == true){
		$("#status_instalador1").html('<h5><span class="badge" style="background-color:#009900;color:#FFF">ATIVO</span></h5>');
	} else {
		$("#status_instalador1").html('<h5><span class="badge" style="background-color:#FF6347;color:#FFF">INATIVO</span></h5>');
	}
}
</script>
