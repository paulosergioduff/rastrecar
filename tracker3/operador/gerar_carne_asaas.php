            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <form name="forml" id="forml" action="gerar_carne_asaas1.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											<div class="row">
												<div class="col-md-12">
													<label>Veiculos que deseja incluir no carnê:</label><br>
													<div class="row">
														<?php
														$cons_veiculos = mysqli_query($conn,"SELECT * FROM veiculos_clientes WHERE id_cliente = '$id_cliente' AND forma_pagamento='Boleto Bancario' ORDER BY id_veiculo ASC");
