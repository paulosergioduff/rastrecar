            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										...
										<small>
											Gerar Recorrência por Boleto - ASAAS Bank
										</small>
									</h1>
								</div>
							</div>
                        ...
                        <form name="forml" id="forml" action="add/add_recorrencia_asaas_boleto.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											<h3><img src="/tracker3/Imagens/asaas.jpg" style="width:30px; heigth:auto;"> DADOS DA RECORRÊNCIA ASAAS (BOLETO BANCÁRIO)</h3>
