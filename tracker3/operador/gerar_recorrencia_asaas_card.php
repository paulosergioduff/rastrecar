            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <form name="forml" id="forml" action="gerar_recorrencia_asaas_card1.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											<h3><img src="/tracker3/Imagens/asaas.jpg" style="width:30px; heigth:auto;"> DADOS DA ASSINATURA ASAAS</h3>
											...
											<div class="row">
												<div class="col-md-12">
													<label>Veiculos que deseja incluir na recorrência:</label><br>
													<div class="row">
														<?php
														$cons_veiculos = mysqli_query($conn,"SELECT * FROM veiculos_clientes WHERE id_cliente = '$id_cliente' AND id_recorrencia <= '0' ORDER BY id_veiculo ASC");
															if(mysqli_num_rows($cons_veiculos) > 0){
																...
																if($recorrencia == 'SIM'){
																	$recorrent = '<i class="fas fa-exclamation-triangle" style="color:#F4A460" data-toggle="popover" data-trigger="hover" data-placement="top" title="ATENÇÃO" data-content="Este veículo já possui recorrência ativa." data-original-title="ATENÇÃO"></i>';
																}
														?>
															...
															<div class="col-md-4">
																<div class="form-group">
																	 <div class="custom-control custom-checkbox custom-control-inline">
																		...
																		<label class="custom-control-label" for="veiculos<?php echo $id_veiculo?>"><?php echo $veiculo11?> <?php echo $recorrent?></label>
																	</div>
																</div>
															</div>
					...
					$status = $_GET['status'];
					$dados_p = $_GET['p'];
					$url_pg = 'https://rastreamentojc.com.br/payment.php?p='.$dados_p.'';
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									<div class="modal-body text-center font-18">
										...
										Assinatura criada com sucesso!<br><br>
