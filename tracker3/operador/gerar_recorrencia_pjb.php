                                        ...
                                        <div class="panel-content">
											...
											<div class="row">
												<div class="col-md-12">
													...
													<div class="row">
														<?php
														$cons_veiculos = mysqli_query($conn,"SELECT * FROM veiculos_clientes WHERE id_cliente = '$id_cliente' AND (id_recorrencia <= '0' OR id_recorrencia=NULL) AND forma_pagamento='Boleto Bancario' ORDER BY id_veiculo ASC");
