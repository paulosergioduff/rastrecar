            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										...
										<small>
											Gerar Recorrência por Boleto - PJ Bank
										</small>
									</h1>
								</div>
							</div>
                        ...
                        <form name="forml" id="forml" action="add/add_recorrencia_pjb_boleto.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											<h3><img src="/tracker3/Imagens/pjb.png" style="width:30px; heigth:auto;"> DADOS DA RECORRÊNCIA (BOLETO BANCÁRIO) - PJ BANK</h3>
											<hr style="border:#CCC 1px solid;">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label>Banco:</label>
														<input type="text" class="form-control" name="banco1" id="banco1" value="PJ BANK" readonly>
														<input type="hidden" class="form-control" name="banco" id="banco" value="1">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
											...
											<div class="row">
												...
												<div class="col-md-2">
													<div class="form-group">
														...
														<select class="select2 form-control" name="tipo" id="tipo" required>
