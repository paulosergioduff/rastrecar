...
$id_usuarios10 = 	$resp_usuario11['id_usuarios'];
	}}
...
$id_cliente_pai20 = 	$resp_cor['id_cliente_pai'];
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <?php include('include/head.php');
						if($acesso == 'GERAL'){
							...
							$botao_loja2 = '<div id="floating-panel9">				
													<a href="grid2.php"><button type="button" class="btn btn-info btn-sm shadow-0" style="font-size:13px; top:0; width:150px; color:#000"><i class="fal fa-home"></i> Loja Fortalza</button></a>							
												</div>';
						}
						if($id_empresa == '1361'){
							$botao_loja1 = ' - LOJA HORIZONTE';
...
?>
					...
					<input type="hidden" id="id_usuarios" value="<?php echo $id_usuarios10?>">
						<div class="row">
							<div class="col-md-4">
							</div>
							<div class="col-md-2">
							...
							<div class="col-md-2">
							<a href="grid_off.php" target="_blank">
								<div class="row bg-white" style="border-radius:5px; border:#CCC 2px solid; color:#000; width:90%;" data-toggle="tooltip" data-placement="bottom" data-offset="0,10" data-original-title="Veículos Offline - Clique para abrir">
									<div class="col-md-6 text-left" >
                                ...
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											<div class="row">
												<div class="col-md-8">
													<input type="hidden" id="customer" value="<?php echo $id_cliente10?>">
											...
											<div id="grid_veiculos" style="width:100%; height: 600px; overflow: auto;"><img src="/tracker2/Imagens/load.gif" style="width:50px; height:auto;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											...
											<div id="floating-panel4">				
												<button type="button" class="btn btn-dark btn-sm shadow-0"  style="font-size:13px; top:0; width:150px;" onclick="zoom();"><i class="fas fa-map-marked-alt"></i> Mostar Todos</button></i>							
											</div>
...
<script>
  function att_veiculos(){
	...
	$.post('include/grid_veiculos_col.php?customer='+customer+'&id_usuarios='+id_usuarios, function(grid_veiculos){
...
<script>
	$(document).ready(function () {
		var customer = document.getElementById("customer").value;
		var id_usuarios = document.getElementById("id_usuarios").value;
		$.post('include/grid_veiculos_col.php?customer='+customer+'&id_usuarios='+id_usuarios, function(grid_veiculos){
			$("#grid_veiculos").html(grid_veiculos);
...
function refreshMap(){
	var id_empresa = document.getElementById("customer").value;
	var id_usuarios = document.getElementById("id_usuarios").value;
  downloadUrl('resultado.php?id_empresa='+id_empresa+'&id_usuarios='+id_usuarios, (data) => {
...
<div class="row">
	<div class="col-md-6">
		...
		<br>
		<br>
		<text><b><i class="far fa-user-circle"></i> Motorista:</b><br> ${driver}</span></text>
	</div>
	<div class="col-md-6">
