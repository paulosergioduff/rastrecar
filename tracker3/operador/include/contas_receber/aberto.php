...
$mes = $meses[$mes1];
	...
	$sql_aberto = mysqli_query($conn, "SELECT * FROM contas_receber WHERE id_empresa='$id_empresa' AND (data_vencimento >= '$data_hoje' AND data_vencimento <= '$data_final') AND status='Em Aberto' ");
