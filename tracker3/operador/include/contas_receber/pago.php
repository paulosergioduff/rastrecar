...
$mes = $meses[$mes1];
	...
	$sql_pago = mysqli_query($conn, "SELECT * FROM contas_receber WHERE id_empresa='$id_empresa' AND (data_vencimento >= '$data_inicial' AND data_vencimento <= '$data_final') AND status='Pago' ");
