...
if($hora >= '06:00' && $hora <= '07:30'){

	
	$cons_recorrencia_5 = mysqli_query($conn, "SELECT * FROM recorrencia WHERE ativo='SIM' AND banco = '2' AND (dia_vencimento='$dias_5' AND dias_cobranca='5') AND ultima_cobranca != '$data_hoje' AND forma_pagamento='Boleto Bancario' AND tipo='MENSAL' ORDER BY id_recorrencia ASC");
