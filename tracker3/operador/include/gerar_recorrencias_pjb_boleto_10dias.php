...
if($hora >= '09:00' && $hora <= '11:30'){
	$cons_recorrencia_5 = mysqli_query($conn, "SELECT * FROM recorrencia WHERE primeiro_vencimento <= '$dia_cont_10' AND ativo='SIM' AND banco = '1' AND (dia_vencimento='$dias_10' AND dias_cobranca='10') AND ultima_cobranca != '$data_hoje' and forma_pagamento='Boleto Bancario' AND tipo='MENSAL'  ORDER BY id_recorrencia ASC");
