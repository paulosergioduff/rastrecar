...
if($hora >= '06:00' && $hora <= '07:00'){
	$cons_recorrencia_5 = mysqli_query($conn, "SELECT * FROM recorrencia WHERE data_termino = '$dia_cont_5' AND ativo='SIM' AND banco = '1' AND forma_pagamento='Boleto Bancario' AND tipo='ANUAL' ORDER BY id_recorrencia ASC");
