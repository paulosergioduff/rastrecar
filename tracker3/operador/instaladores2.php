            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
					...
					if($acesso == 'GERAL'){
						...
						$botao_loja2 = '<a href="instaladores.php"><button type="button" class="btn btn-dark btn-sm" style="font-size:14px"><i class="fal fa-home" ></i> Loja Horizonte</button></a>';
                    ...
                    <main id="js-page-content" role="main" class="page-content">
						...
						<div class="row">
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-users'></i> Instaladores - Loja Fortaleza
										<small>
							...
							<a href="novo_instalador.php?c=1362"><button type="button" class="btn btn-info btn-sm" style="font-size:14px"><i class="fal fa-user-plus"></i> Novo Instalador</button></a>
							</div>
						</div>
