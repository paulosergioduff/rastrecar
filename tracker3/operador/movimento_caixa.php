...
if(mysqli_num_rows($sql_caixa) > 0){
	...
	$data_hoje = $resp_caixa['data'];
	$data_hoje1 = date('d/m/Y', strtotime("$data_hoje"));
}}
...
$sql_entradas_din = mysqli_query($conn,"SELECT * FROM movimento_caixa WHERE id_caixa = '$id_caixa' AND tipo='ENTRADA' AND forma_pagamento='DINHEIRO'");
...
$sql_entradas_card = mysqli_query($conn,"SELECT * FROM movimento_caixa WHERE id_caixa = '$id_caixa' AND tipo='ENTRADA' AND forma_pagamento != 'DINHEIRO'");
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-file'></i> Movimentos Caixa <?php echo $data_hoje1;?>
										<small>
											Movimentos de Caixa
										</small>
									</h1>
...
$result_usuario = "SELECT * FROM movimento_caixa WHERE id_caixa = '$id_caixa' ORDER BY id_mov DESC";
...
?>
                        <table id="example" class="table table-bordered table-hover table-striped">
							...
							if($tipo == 'SAIDA'){
								$tipo1 = '<h5><span class="badge" style="background-color:#990000;color:#FFF">SAÍDA</span></h5>';
								$recibo = '';
							}
