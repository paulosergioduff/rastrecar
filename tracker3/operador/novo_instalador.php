            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper ">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-users'></i> Novo Instalador
										<small>
											Cadastro de Instaladores Novos
										</small>
									</h1>
								</div>
							</div>
                        ...
                        <form name="forml" id="forml" action="add/add_instalador.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                        ...
                                        <div class="panel-content">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="nome_instalador" autocomplete="off" id="nome_instalador" class="form-control text-uppercase" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label>CPF/CNPJ:</label>
														<input type="text" name="doc_instalador" autocomplete="off" id="doc_instalador" class="form-control" onkeypress='mascaraMutuario(this,cpfCnpj)' onblur='clearTimeout()' maxlength="18" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label>E-mail:</label>
														<input type="text" name="email" id="email" autocomplete="off" class="form-control text-lowercase" autocomplete="off" required>
													</div>
												</div>
											</div><br>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label>CEP:</label>
														<input type="text" name="cep" id="cep" autocomplete="off" class="form-control" maxlength="8" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label>Endereço:</label>
														<input type="text" name="endereco" id="endereco" class="form-control text-uppercase" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="estado" id="estado" class="form-control text-uppercase" required>
													</div>
												</div>
											</div><br>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="telefone_celular" id="telefone_celular" autocomplete="off" onKeyUp="mascara( this, mtel );" maxlength="15" class="form-control"  required>
													</div>
												</div>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="vlr_inst_bloqueio" id="vlr_inst_bloqueio" onkeypress="return(MascaraMoeda(this,'.',',',event))" value="0,00" autocomplete="off" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label>Valor Instalação sem Bloqueio:</label>
														<input type="text" name="vlr_inst" id="vlr_inst" onkeypress="return(MascaraMoeda(this,'.',',',event))" value="0,00" autocomplete="off" class="form-control">
													</div>
												</div>
											</div><br>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="vlr_manutencao" id="vlr_manutencao" onkeypress="return(MascaraMoeda(this,'.',',',event))" value="0,00" autocomplete="off" class="form-control">
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label>Valor Retirada:</label>
														<input type="text" name="vlr_retirada" id="vlr_retirada" onkeypress="return(MascaraMoeda(this,'.',',',event))" value="0,00" autocomplete="off" class="form-control">
													</div>
												</div>
											</div><br><br>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label>Usuário:</label>
														<input type="text" name="usuario" id="usuario" autocomplete="off" class="form-control">
											...
											<div class="row">
											   <div class="col-md-3">
													<div class="form-group">
														<button type="submit" id="botao" class="btn btn-info btn-sm">Cadastrar Instalador</button>
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group">
											...
											<input type="hidden" name="customer_fact" id="customer_fact" value="<?php echo $id_cliente10?>">
