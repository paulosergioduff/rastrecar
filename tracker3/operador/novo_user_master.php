               ...
               <aside class="page-sidebar" style="background-color:#14145A">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <form action="add/add_usuario_master.php" name="forml" id="forml" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                        ...
                                        <div class="panel-content">
											 ...
											 <div class="row">
												...
												<div class="col-md-3">
													...
													<input type="text" class="form-control" name="telefone_celular" id="telefone_celular"  required>
												</div>
											</div><br>
											<div class="row">
												<div class="col-md-12">
													<label>Veículos para vincular:</label><br>
											...
											<div class="row">
												<div class="col-md-4">
													...
													<div class="custom-control custom-switch" >
														<input type="checkbox" class="custom-control-input" name="bloqueio" value="SIM" id="bloqueio">
