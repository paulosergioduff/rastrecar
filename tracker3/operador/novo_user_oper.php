...
$nome_cliente = 	$resp_cor['nome_cliente'];
											  ...
											  <div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="hidden" class="form-control" name="cliente" id="cliente" value="<?php echo $id_cliente10?>" required>
	  ...
	  $("select[name=cliente]").change(function(){
		...
		$(document).ready(function () {
				...
				function email(cliente){
					...
					$.post('ajax/email_cliente.ajax.php', dados , function(retorna_email){
						//Subtitui o valor no seletor id="conteudo"
