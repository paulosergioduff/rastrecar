               ...
               <aside class="page-sidebar" style="background-color:#FFF">
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <form name="forml" id="forml" action="add/add_veiculo_comp.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
					...
					<div class="modal fade" id="estoque" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog  modal-xl">
				<div class="modal-content">
					<div class="modal-header text-white bg-primary">
						<h5 class="modal-title" id="myLargeModalLabel" style="color:#FFF;">DISPOSITIVOS EM ESTOQUE</h5>
...
$result_usuario = "SELECT * FROM estoque_rastreadores WHERE status='ESTOQUE'";
...
?>
                        <table id="dt-basic-example" class="table table-bordered table-hover table-striped nowrap" style="width:100%">
							...
							$data_entrada = $row_usuario['data_entrada'];
							...
							?>
                                <tr>
                                    <td style="fonta-size:10px;"><?php echo $modelo_equip; ?></td>
                                    <td><?php echo $imei; ?></td>
                                    <td><?php echo $chip; ?></td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-sm" onclick="editar(this)">Selecionar</button>
                                    </td>
                                </tr>
						...
						echo "<div class='alert alert-dark text-center' role='alert'>NENHUM EQUIPAMENTO EM ESTOQUE!</div>";
						}
						?>
					</div>
