            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper ">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-users'></i> Novo Vendedor
										<small>
											Cadastro de Vendedores Novos
										</small>
									</h1>
								</div>
							</div>
                        ...
                        <form name="forml" id="forml" action="add/add_vendedor.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="nome_vendedor" autocomplete="off" id="nome_vendedor" class="form-control text-uppercase" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<label>CPF/CNPJ:</label>
														<input type="text" name="doc_vendedor" autocomplete="off" id="doc_vendedor" class="form-control" onkeypress='mascaraMutuario(this,cpfCnpj)' onblur='clearTimeout()' maxlength="18" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" name="comissao_fixa" id="comissao_fixa" onkeypress="return(MascaraMoeda(this,'.',',',event))" value="0,00" autocomplete="off" class="form-control">
													</div>
												</div>
											</div><br>
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														<label>Valor/Percentual:</label>
														<input type="text" name="comissao_recorrente" id="comissao_recorrente" onkeypress="return(MascaraMoeda(this,'.',',',event))" value="0,00" autocomplete="off" class="form-control">
													</div>
												</div>
											</div><br><br>
