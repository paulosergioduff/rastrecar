                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
						...
						<div class="row">
							...
							<a href="cad_cliente_os.php?c=<?php echo $base64_cliente?>"><button type="button" class="btn btn-dark btn-sm" style="font-size:14px"><i class="fal fa-user"></i> Voltar</button></a>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-sm-4">
										<div class="form-group">
											<img src="/tracker3/manager/logos/<?php echo $logo?>" style="width:150px; heigth:auto" alt="SmartAdmin WebApp" aria-roledescription="logo">
										</div>
									</div>
									<div class="col-sm-4 text-center" style="color:#000;">
										<div class="form-group">
									...
									<div class="col-sm-4 text-right">
										<div class="form-group">
											<img src="/tracker/Imagens/logo2.png" style="width:100px; heigth:auto" alt="SmartAdmin WebApp" aria-roledescription="logo">
										</div>
									</div>
								</div>
