...
$('#forml').on('submit', function(e){
  $('#carregar').modal('show');
		...
		function abrir(){
			...
			window.open("http://jctracker.com.br/tracker2/manager/mapa_rel2.php?id_relatorio="+id_relatorio+"&deviceid="+device_id+"&data_inicial="+data_ini+"&data_final="+data_fin, "minhaJanela", "height=700,width=1000");
		}
	</script>
	<script>
	var base64 = document.getElementById("base64").value;
	function imprimir(){
		window.open("http://jctracker.com.br/tracker2/manager/imprimir_relatorio_cercas.php?c="+base64, "minhaJanela", "height=700,width=1000");
	}
</script>
</body>
</html>
