									 ...
									 <div class="form-group">
										<div class="row">
											...
											<div class="col-md-2 text-right">
												<p>													
												<a href="#" onclick="window.open('http://rastreiamaisbrasil.com.br/tracker3/operador/mapa_rel1.php?data_inicial=<?php echo $temp_data_inicial?>&data_final=<?php echo $temp_data_final?>&deviceid=<?php echo $deviceid?>','Janela', width='900',height='900'); return false;"><button type="button" class="btn btn-dark btn-sm" data-toggle="modal" data-target="#mapa"><b><i class="fas fa-route"></i> Visualizar Percurso</b></button></a> 	
