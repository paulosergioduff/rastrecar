        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <div class="page-content-wrapper ">
					...
					$id_empresa = 1362;
					if($acesso == 'GERAL'){
						$botao_loja2 = '<a href="relatorios_caixa.php"><button type="button" class="btn btn-dark btn-sm shadow-0" style="font-size:14px"><i class="fal fa-home"></i> Loja Horizonte</button></a>';
