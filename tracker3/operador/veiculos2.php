    ...
    <body class="mod-bg-1 nav-function-fixed">
        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <aside class="page-sidebar" style="background-color:#14145A">
					...
					if($acesso == 'GERAL'){
						$botao_loja1 = '';
						$botao_loja2 = '<a href="veiculos.php"><button type="button" class="btn btn-dark btn-sm"><i class="fal fa-home"></i> Loja Horizonte</button></a>';
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										...
										<small>
											Cadastro de Veículos - LOJA FORTALEZA
										</small>
									</h1>
								</div>
							</div>
        ...
        $(document).ready(function(){
            $('#dt-basic-example').DataTable({
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url':'include/list_veiculos2.php'
                },
                'columns': [
                    { data: 'id_veiculo' },
                    { data: 'opcoes' },
