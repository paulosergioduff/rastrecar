        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <div class="page-content-wrapper header-function-fixed">
					...
					if($equipamentos == '1'){
						$equipamentos2 = 'Selecionado Todos';
					}
					if($equipamentos != '1'){
						$equipamentos2 = $equipamentos;
					}
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<select class="select2 form-control w-100" name="equipamentos" id="equipamentos"  required>
														  <option value="<?php echo $equipamentos?>"><?php echo $equipamentos2?></option>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group" id="data_1">
														...
														<input type="date" class="form-control" name="data_inicial" id="data_inicial" value="<?php echo $data_inicial?>" autocomplete="off"  required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group" id="data_1">
														<label class="font-normal">Data Final:</label>
														<input type="date" class="form-control" name="data_final" id="data_final" value="<?php echo $data_final?>" autocomplete="off" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
                            ...
                            <div class="col-xl-12">
                                <div id="panel-1" class="panel">
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
											<h3>
											<a href="excel/veiculos_relatorio.php?data_inicial=<?php echo $data_inicial?>&data_final=<?php echo $data_final?>&cliente=<?php echo $cliente?>&equipamentos=<?php echo $equipamentos?>"><button type="button" class="btn btn-success btn-sm shadow-0"><i class="fas fa-file-excel"></i> Excel</button></a> 
											<a href="pdf_files/veiculos_relatorio.php?data_inicial=<?php echo $data_inicial?>&data_final=<?php echo $data_final?>&cliente=<?php echo $cliente?>&equipamentos=<?php echo $equipamentos?>" target="_blank"><button type="button" class="btn btn-sm shadow-0" style="background-color:#CD5C5C; color:#FFF"><i class="fas fa-file-pdf"></i> PDF</button></a>
											</h3>
											...
											if($cliente == '1'){
												if($equipamentos == '1'){
													$tabela = "SELECT * FROM veiculos_clientes WHERE data_cadastro >= '$data_inicial' AND data_cadastro <= '$data_final' ORDER BY data_cadastro ASC";
												}
												if($equipamentos != '1'){
													$tabela = "SELECT * FROM veiculos_clientes WHERE modelo_equip='$equipamentos' AND (data_cadastro >= '$data_inicial' AND data_cadastro <= '$data_final') ORDER BY data_cadastro ASC";
												}
											}
											
											if($cliente != '1'){
												if($equipamentos == '1'){
													$tabela = "SELECT * FROM veiculos_clientes WHERE id_cliente='$cliente' AND (data_cadastro >= '$data_inicial' AND data_cadastro <= '$data_final') ORDER BY data_cadastro ASC";
												}
												if($equipamentos != '1'){
													$tabela = "SELECT * FROM veiculos_clientes WHERE id_cliente='$cliente' AND modelo_equip='$equipamentos' AND AND (data_cadastro >= '$data_inicial' AND data_cadastro <= '$data_final') ORDER BY data_cadastro ASC";
												}
											}
											...
											$encerramento_os = $row_usuario['encerramento_os'];
											...
											<tr>
												...
												<td><?php echo $encerramento_os; ?></td>
											</tr>
