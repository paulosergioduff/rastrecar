			...
			$coordenadas = str_replace('@', ',', $coordenadas);
                ...
                <div class="page-content-wrapper header-function-fixed">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                            ...
                            <div class="col-xl-8">
								<div class="subheader">
									<h1 class="subheader-title">
										<i class='subheader-icon fal fa-road'></i> Cerca Eletrônica
										<small>
											Dados da Cerca
										</small>
									</h1>
                        ...
                        <form name="forml" id="forml" action="relatorio_cerca1.php" method="post">
                        <div class="row">
                            <div class="col-xl-12">
                                        ...
                                        <div class="panel-content">
											...
											<div class="row">
												...
												<div class="col-md-6">
													...
													<label><b>VEÍCULOS CERCA:</b></label><br>
													<?php
													...
													<div class="row">
														...
														<div class="col-md-4">
															<a href="delete_veic_cerca.php?deviceid=<?php echo $deviceid?>&geofenceid=<?php echo $geofenceid?>&pag=0"><button type="button" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Excluir</button></a>
														</div>
													</div>
													...
													<select class="select2 form-control w-100" multiple="multiple" name="veiculos[]" id="veiculos">
														<?php
													...
													<input type="hidden" id="id_cerca" name="id_cerca" value="<?php echo $id_cerca?>"><br>
