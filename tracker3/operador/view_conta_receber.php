                                        ...
                                        <div class="panel-content">
											<div class="row">
												...
												<div class="col-md-8 text-right">
													...
													<?php echo $botao_whats?>
													<?php echo $botao_carne?>
													<?php echo $botao_boleto?>
													<a href="editar_conta_receber.php?c=<?php echo $base64?>"><button type="button" class="btn btn-dark btn-sm"><i class="fal fa-edit"></i> Editar</button></a>
						...
						<div class="modal-dialog modal-dialog-centered">
							<div class="modal-content">
								...
								<div class="modal-footer">
									 ...
									 <button type="button" onclick="delete_conta()" class="btn btn-danger">Excluir</button>
								</div>
							</div>
						</div>
					</div>
